...
import { KuduComponentTeleport, KuduTemplateTeleport } from '../interfaces';
...
export class KuduTemplateTeleportRef<C = any> implements KuduTeleportRef {
  private embeddedViewRef: EmbeddedViewRef<C> | null = null;

  constructor(private teleport: KuduTemplateTeleport) {}
...
export class KuduComponentTeleportRef<C = any> implements KuduTeleportRef {
  private componentRef: ComponentRef<C> | null = null;

  constructor(
    private teleport: KuduComponentTeleport,
  ...
  private createComponent(teleport: KuduComponentTeleport) {
    if (teleport.vcRef) {
