...
import { MkDateMonth } from './date-month';
import { MkDateWeek } from './date-week';
...
export class MkDate {
  ...
  public toMonth() {
    return new MkDateMonth(this);
  }

  public toWeek() {
    return new MkDateWeek(this);
  }
